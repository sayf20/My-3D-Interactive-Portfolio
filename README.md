...
1. Clone this repository:
   ```bash
   git clone https://github.com/sayf20/My-3D-Interactive-Portfolio.git
   ```

2. Navigate to the project directory:
   ```bash
   cd My-3D-interactive-portfolio
   ```
...
- **LinkedIn:** [Your LinkedIn Profile](https://www.linkedin.com/in/saifeddine-mosrati-60436b2bb/)
